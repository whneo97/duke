...
/**
 * Defines a public class CannotUndoException extends DukeException {
 object that extends the DukeException class.
 * Signals an error when a client of the Duke program encounters an exception while attempting to access history
 * of TaskLists.
 */
public class CannotUndoException extends HistoryException {

    /**
     * Creates an instance of public class CannotUndoException extends DukeException {
