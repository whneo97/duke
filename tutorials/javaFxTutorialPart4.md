...
Let's return to seedu.duke.model.Duke and convert it to use FXML instead.
...
As part of the effort to separate the code handling seedu.duke.model.Duke's logic and UI, let's _refactor_ the UI-related code to its own class.
...
public class MainWindow extends AnchorPane {
    ...
    private seedu.duke.model.Duke duke;
    ...
    public void setDuke(seedu.duke.model.Duke d) {
        duke = d;
    }
...
Let's create a new `Main` class as the bridge between the existing logic in `seedu.duke.model.Duke` and the UI in `MainWindow`.
...
public class Main extends Application {
    ...
    private seedu.duke.model.Duke duke = new seedu.duke.model.Duke();
