# JavaFX Tutorial Part 2 - Creating a GUI for seedu.duke.model.Duke

In this tutorial, we will be creating a GUI for seedu.duke.model.Duke from scratch based on the following mockup.

![Mockup for seedu.duke.model.Duke](assets/DukeMockup.png)
...
![seedu.duke.model.Duke's layout](assets/DukeSceneGraph.png) 
...
![seedu.duke.model.Duke's raw layout](assets/RawLayout.png)
...
```java
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("seedu.duke.model.Duke");
...
![seedu.duke.model.Duke's Final layout](assets/FinalLayout.png)
