# JavaFX Tutorial Part 2 - Creating a GUI for seedu.duke.Duke

In this tutorial, we will be creating a GUI for seedu.duke.Duke from scratch based on the following mockup.

![Mockup for seedu.duke.Duke](assets/DukeMockup.png)
...
![seedu.duke.Duke's layout](assets/DukeSceneGraph.png) 
...
![seedu.duke.Duke's raw layout](assets/RawLayout.png)
...
![seedu.duke.Duke's Final layout](assets/FinalLayout.png)
